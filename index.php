...
<!------------Featured Products------------------>
    <div class="small-container">
    	...
    	<div class="row">
    		<div class="col-4">
    			<a href="products detail.php"><img src="image/product-1.jpg"></a>
    	...
    	<div class="small-container">
    		<div class="row">
    			...
    			<div class="col-2">
    				...
    				<h1>Smart Band 4</h1>
    				<small>The Mi Smart Band 4 features a 39.9% larger (thyan MI band 3) AMOLED Color full-touch display with adjustable brightness, so everything is clear as can be.</small>
...
<!-------------------Footer------------------->
    <div class="footer">
    	<div class="container">
    		...
    		<hr>
    		<p class="copyright">Copyright 2020 @ C.Com.......</p>
    	</div>
    </div>
